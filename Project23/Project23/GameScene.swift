...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMoveToView(view: SKView) {
        gameTimer = NSTimer.scheduledTimerWithTimeInterval(0.45, target: self, selector: "createEnemy", userInfo: nil, repeats: true)
    ...
    func didBeginContact(contact: SKPhysicsContact) {
        ...
        gameOverImage.position = CGPoint(x: 512, y: 384)
