...
class GameScene: SKScene {
    ...
    override func didMoveToView(view: SKView) {
        ...
        for i in 0 ... 4 { createSlotAt(CGPoint(x: 100 + (i * 170), y: 410)) }
        for i in 0 ... 3 { createSlotAt(CGPoint(x: 180 + (i * 170), y: 320)) }
        for i in 0 ... 4 { createSlotAt(CGPoint(x: 100 + (i * 170), y: 230)) }
        for i in 0 ... 3 { createSlotAt(CGPoint(x: 180 + (i * 170), y: 140)) }
